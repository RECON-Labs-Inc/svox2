...
# USAGE:
# vx_pre_process_poses.sh <PROJECT_FOLDER> <[OPTIONAL] LOG_FILE> <MS_DOWNSAMPLING>


# DETAILED DESCRIPTION:
# Chains the following steps (please see pre_process.py for reference)

# 1. Computes poses (raw)
# 2. Exports the poses and calibration
# 3. Converts the data to Tanks and Temples format
